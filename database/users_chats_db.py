...
my_client = MongoClient(OTHER_DB_URI, tls=True, tlsAllowInvalidCertificates=True)
...
class Database:
    ...
    def __init__(self, uri, database_name):
        self._client = motor.motor_asyncio.AsyncIOMotorClient(uri, tls=True, tlsAllowInvalidCertificates=True)
